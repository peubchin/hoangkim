    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><em class="fa fa-table">&nbsp;</em>Danh sách gói sản phẩm</h3>
            ...
            <div class="box-body">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right">F0(%)</th>
                                        <th class="text-right">F1(%)</th>
                                        <th class="text-right">F2(%)</th>
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo formatRice($row['price']); ?></td>
                                            <td class="text-right"><?php echo $row['F0']; ?></td>
                                            <td class="text-right"><?php echo $row['F1']; ?></td>
                                            <td class="text-right"><?php echo $row['F2']; ?></td>
                ...
                <?php else: ?>
                    <div class="callout callout-warning">
                        <h4>Thông báo!</h4>
                        <p><b>Không</b> có gói sản phẩm nào!</p>
                    </div>
                <?php endif;?>
            </div>
