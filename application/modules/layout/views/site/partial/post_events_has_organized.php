		...
		<div class="wpb_wrapper">
			<div class="vc_separator vc_text_separator vc_separator_align_center vc_sep_width_100 vc_sep_pos_align_center">
				<span class="vc_sep_holder vc_sep_holder_l">
					<span style="background-image: -webkit-linear-gradient(left,transparent, sandy_brown);background-image: linear-gradient(to right, transparent, sandy_brown);" class="vc_sep_line"></span></span>
				<h3>SỰ KIỆN ĐÃ TỔ CHỨC</h3>
				<span class="vc_sep_holder vc_sep_holder_r">
					<span style="background-image: -webkit-linear-gradient(left, sandy_brown, transparent);background-image: linear-gradient(to right, sandy_brown, transparent);" class="vc_sep_line">
					</span>
				</span>
			</div>
			<br>        
			<div class="bt368-nav-ptt jps_bete_custom_css3378 grid-style-box-nav" id= "jps_bete_custom_css3378" data-style="bt-post-grid-3">               
				<div class="bt368-nav-ptt-content  bt-fix-top-filter"> <!--bt368-nav-ptt-content--> 
