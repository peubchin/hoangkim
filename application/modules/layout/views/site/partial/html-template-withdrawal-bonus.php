        ...
        <tr>
            <td>
                <table width="750px" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" align="center">
                    <tbody>
                        <tr>
                            <td valign="top" style="padding-top:30px;font-family:Helvetica neue,Helvetica,Arial,Verdana,sans-serif;color:#205081;font-size:20px;line-height:32px;text-align:left;font-weight:bold" align="left">Thông báo hệ thống: Yêu cầu rút tiền thưởng</td>
                        </tr>
						<tr>
						...
						<tr>
                            <td valign="top" style="font-family:Helvetica,Helvetica neue,Arial,Verdana,sans-serif;color:#333333;font-size:14px;line-height:20px;text-align:left;font-weight:none" align="left">Thành viên <strong><?php echo $data['full_name']; ?> (ID: <?php echo $data['user_id']; ?>)</strong> vừa gửi yêu cầu rút tiền thưởng vào ngày <b><?php echo date('d/m/Y', $data['created']); ?></b> lúc <b><?php echo date('h:i A', $data['created']); ?></b>
                        </tr>
                        <tr>
