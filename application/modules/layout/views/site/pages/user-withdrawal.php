          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
              <div class="account-structure-page_main-content">
                <div class="account-change-email">
                  <h2 class="account-structure-page_title">Thông tin rút tiền <a href="<?php echo site_url('lich-su-rut-tien'); ?>" class="float-right"><i class="fa fa-history" aria-hidden="true"></i> Lịch sử rút tiền</a></h2>
                  <div class="box-devision-col-mobile">
                    ...
                    <div class="account-change-email">
                      <form id="f-withdrawal" action="<?php echo current_full_url(); ?>" method="post">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-5">
                        <p class="account-change-email_header">Chọn phương thức rút tiền: </p>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="row form-group">
                <div class="col-lg-4 col-md-5 col-sm-5 offset-lg-3 offset-md-3 offset-sm-5">
                  ...
                  <button type="submit" class="btn btn-warning account-change-email_btn-last">Rút tiền</button>
                </div>
              </div>
            </form>
            <div style="text-align:center; border: solid 1px grey;margin:20px;">
                        <p>(*)Lưu ý: Thành viên vui lòng nhập thông tin tài khoản ngân hàng trong phần tài khoản cá nhân<br>
                          Lệnh rút tiền được thực hiện vào ngày 5 và 6 hàng tháng <br>Thời gian nhận thanh toán từ 1h đến 48h<br>
