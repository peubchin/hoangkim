                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="account-structure-page_main-content">
                                <div class="account-change-email">
                                    <h2 class="account-structure-page_title">Lịch sử rút tiền thưởng</h2>
                                    <div class="row">
                                        <?php if($bool): ?>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="card card-stats">
                                                <div class="card-header card-header-success card-header-icon">
                                                    ...
                                                    <p class="card-category">Tổng số tiền thưởng đã rút thành công</p>
                                                    <h3 class="card-title">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="card card-stats">
                                                <div class="card-header card-header-warning card-header-icon">
                                                    ...
                                                    <p class="card-category">Tổng số tiền thưởng rút đang chờ xử lý</p>
                                                    <h3 class="card-title">
