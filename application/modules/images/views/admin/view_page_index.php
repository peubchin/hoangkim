                                ...
                                <tbody>
                                    <?php foreach ($rows as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img class="img-responsive img-thumbnail" src="<?php echo base_url(get_module_path('images') . $row['image']); ?>" width="80px;" alt="<?php echo $row['alt']; ?>" >
                                            </td>
                                            <td><?php echo $row['title']; ?></td>
                                            <td><?php echo $row['link']; ?></td>
                                            <td class="text-center"><span class="label label-info"><?php echo display_value_array($this->config->item('images_modules'), $row['post_type']); ?></span></td>
                                            <td class="text-center"><span class="label label-success"><?php echo $row['position']; ?></span></td>
